...
export default function VendorAllVendorsPage() {
      ...
      <main className="container-modern py-8">
        <AdminBreadcrumb
          items={[
            ...
            { label: 'All Vendors', href: '/vendor/all-vendors' },
          ]}
        />
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
          ...
          <p className="text-gray-600 mt-2">
            Search all vendors by service category and location.
          </p>

          <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="vendor-category" className="block text-sm font-medium text-gray-700 mb-2">
                Category
              </label>
              <select
                id="vendor-category"
            ...
            <div>
              <label htmlFor="vendor-location" className="block text-sm font-medium text-gray-700 mb-2">
                Location
              </label>
              <input
                id="vendor-location"
