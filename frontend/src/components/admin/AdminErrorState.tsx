...
export function AdminInlineError({ message, onDismiss }: { message: string; onDismiss?: () => void }) {
  return (
...
export function AdminSuccessMessage({ message, onDismiss }: { message: string; onDismiss?: () => void }) {
  return (
