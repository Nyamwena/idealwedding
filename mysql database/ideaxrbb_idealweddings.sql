-- Ideal Weddings production-ready MySQL/MariaDB baseline
-- Upload/import this single file on server.
...
DROP TABLE IF EXISTS `vendor_credit_balances`;
...
CREATE TABLE `vendor_credit_balances` (
  `id` varchar(36) NOT NULL,
  `vendor_id` varchar(36) NOT NULL,
...
INSERT INTO `User` (`id`, `email`, `password`, `firstName`, `lastName`, `role`, `createdAt`)
VALUES
...
ALTER TABLE `Category` AUTO_INCREMENT = 2;
