-- Ideal Weddings non-destructive migration baseline
-- Purpose: keep existing data, create/add missing structures only.
...
-- ------------------------------------------------------------------
-- Seed minimum required data without replacing existing
-- ------------------------------------------------------------------

INSERT IGNORE INTO `Category` (`id`, `name`, `slug`, `createdAt`)
VALUES (1, 'Weddings', 'weddings', current_timestamp(3));

INSERT IGNORE INTO `User` (`id`, `email`, `password`, `firstName`, `lastName`, `role`, `createdAt`)
VALUES
  (1, 'ideal@idealweddings.com', '$2b$10$4IXx2jkU.5VWSjCEiuZ.u.l/2pKIspmI6MOhTjJ3zqNyD2nVTjUli', 'Ideal', 'Admin', 'ADMIN', current_timestamp(3));
